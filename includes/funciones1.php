<?php
	...
	{
		if($direccion == "DG"  || $direccion != "C")
		{
		
			$menu = '
				<ul class="select menu" id="mInicio">
				<li><a href="#nogo" class="munuSup"><b>Pliego de Observaciones</b><!--[if IE 7]><!--></a><!--<![endif]-->
				...
				if($soloReportes != 1 )$menu .= '<li><a class="menu_po redonda3" href="?cont=po_oficios"> <img src="images/volantes.png" /> <span>PO Offices</span> </a></li>';
				...
				$menu .= '<li><a class="menu_po redonda3" href="?cont=po_busqueda&reports='.$soloReportes.'"> <img src="images/search16.png" />Advanced Search</a></li>';
				if($direccion == "DG" )
				...
				if($soloReportes != 1 )$menu .= '<li><a class="menu_pfrr redonda3" href="?cont=pfrr_oficios"> <img src="images/volantes.png" /> <span>PFRR Offices</span> </a></li>';
				...
				$menu .= '<li><a class="menu_pfrr redonda3" href="?cont=pfrr_busqueda&reports='.$soloReportes.'"><img src="images/search16.png" /><span>Advanced Search</span></a></li>';
				...
				if($direccion == "DG" || $direccion == "C")
				{
					...
					<ul class="select menu" id="mInicio">
						<li><a href="#" class="munuSup"><b>Means of Defense</b><!--[if IE 7]><!--></a><!--<![endif]-->
							<!--[if lte IE 6]><table><tr><td><![endif]-->
								<ul class="sub submenu redonda5 ulMd">';
									if($soloReportes != 1 )$menu .= '<li><a class="menu_md redonda3" href="?cont=medios_actores"> <img src="images/medio_reconcideracion_small.png" /> <span> Ver Actores </span> </a>';
									...
									if($soloReportes != 1 )$menu .= '<li><a class="menu_md redonda3" href="#"> <img src="images/medio_nulidad_small.png" /> <span> Juicio de Nulidad </span> </a>
																		<ul class="submenu2 redonda5">
																			<li> <a class="menu_md redonda3" href="?cont=nulidad_escritorio"> <img src="images/actor.png" /> Ver Actores </a> </li>
									...
									if($soloReportes != 1 )$menu .= '<li><a class="menu_md redonda3" href="?cont=revision_escritorio"><img src="images/medio_revision_small.png" /> <span> Recurso de Revisión </span></a>
																		<ul class="submenu2 redonda5">
																			<li> <a class="menu_md redonda3" href="#"> <img src="images/actor.png" /> Ver Actores </a> </li>
																			<li> <a class="menu_md redonda3" href="#"> <img src="images/book_red.png" /> Oficios </a> </li>
																		</ul>
				...
				*/
				...
				<ul class="select menu" id="mInicio">
					<li><a href="#nogo" class="munuSup"><b>Reports</b><!--[if IE 7]><!--></a><!--<![endif]-->
					<!--[if lte IE 6]><table><tr><td><![endif]-->
						<ul class="sub submenu redonda5 ulRep">';
							if($direccion == "DG" || $nivel == "S") 
							{
								$menu .= '<li><a class="menu_rep redonda3" href="'.damedominio().'/indexdirx.php"> <img src="images/desktop.png" /> <span>Pantalla DG</span> </a> </li>';
								$menu .= '<li><a class="menu_rep redonda3" href="?cont=rep_reportesDG"> <img src="images/bar-chart-icon.png" /> <span>Reportes DG</span> </a> </li>';
							}
							$menu .= '<li><a class="menu_rep redonda3" href="?cont=rep_diario_comportamiento_po"> <img src="images/report-icon0.png" /> <span>PO CP2012</span> </a></li>';
							$menu .= '<li><a class="menu_rep redonda3" href="?cont=rep_po_trimestral"> <img src="images/report-icon.png" /> <span>PO Notificados CP2012</span> </a></li>';
							$menu .= '<li><a class="menu_rep redonda3" href="?cont=rep_po_ejecutivo"> <img src="images/blue-document-table-icon.png" style="width:17px"/> <span>PO Informe Ejecutivo CP2012</span> </a></li>';
							$menu .= '<li><a class="menu_rep redonda3" href="?cont=historico_pfrr"> <img src="images/historico.png" /> <span>Historico de Resoluciones</span> </a></li>';
							$menu .= '<li><a class="menu_rep redonda3" href="?cont=emision_resoluciones"> <img src="images/Apps-preferences-system-time-icon.png" /> <span>Emisión de Resoluciones</span> </a></li>';
							$menu .= '<li><a class="menu_rep redonda3" href="?cont=montos_modificados"> <img src="images/monto.png" /> <span>Diferencias Montos PO CP2012</span> </a></li>';
							$menu .= '<li><a class="menu_rep redonda3" href="?cont=po_asistidos"> <img src="images/asistidos.png" /> <span>Pliegos Asistidos</span> </a></li>';
				...
				if($direccion == "DG")
				{
					...
					<ul class="select menu" id="mInicio">
						<li><a href="#nogo" class="munuSup"><b>Administration</b><!--[if IE 7]><!--></a><!--<![endif]-->
						<!--[if lte IE 6]><table><tr><td><![endif]-->
							<ul class="sub submenu redonda5 ulAdm" >';
								if($soloReportes != 1)$menu .= '<li><a class="menu_adm redonda3" href="?cont=empleados_principal"> <img src="images/presuntos.png" /> <span>Personal</span> </a>
																<ul class="submenu2 redonda5">
																<li> <a class="menu_adm redonda3" href="?cont=empleados_alta"> <img src="images/alta.png" />Alta </a> </li>
																</ul>
																<li> <a class="menu_adm redonda3" href="?cont=prueba.pdf"> <img src="images/organigrama.png" />Organigrama </a> </li>
																</li>';
				...
				if($direccion == "DG" || $nivel == "S")
				{
					...
					<div class="nav-divider">&nbsp;</div>
					<ul class="select menu" id="mInicio">
						<li><a href="#nogo" class="munuSup"><b>Leaflets</b><!--[if IE 7]><!--></a><!--<![endif]-->
						<!--[if lte IE 6]><table><tr><td><![endif]-->
							<ul class="sub submenu redonda5 ulVol">';
								if($soloReportes != 1)$menu .= '<li><a class="menu_vol redonda3" href="?cont=vol_volantes_po"> <img src="images/doc_blue.png" /> <span>Leaflets PO</span> </a></li>';
								if($soloReportes != 1)$menu .= '<li><a class="menu_vol redonda3" href="?cont=vol_volantes_pfrr"> <img src="images/vol_pfrr.png" /> <span>Leaflets PFRR</span> </a></li>';
									
								if($soloReportes != 1)$menu .= '<li><a class="menu_vol redonda3" href="#"> <img src="images/doc_red.png" /> <span>Leaflets MD</span> </a>
																	<ul class="submenu2 redonda5">
																		...
																		<li> <a class="menu_vol redonda3" href="?cont=vol_volantes_medios"> <img src="images/doc_red.png" /> <span>Juicio de Nulidad</span> </a></li>
								...
								if($soloReportes != 1)$menu .= '<li><a class="menu_vol redonda3" href="?cont=vol_volantes_legal"> <img src="images/doc_orange.png" /> <span>Leaflets Legal Opinions</span> </a></li>';
								if($soloReportes != 1)$menu .= '<li><a class="menu_vol redonda3" href="?cont=vol_volantes_adm"> <img src="images/doc_pink.png" /> <span>Leaflets Administration</span> </a></li>';
								if($soloReportes != 1)$menu .= '<li><a class="menu_vol redonda3" href="?cont=vol_volantes_search"> <img src="images/search16.png" /> <span>Search Leaflets</span> </a></li>';
					$menu .= '</ul>
							<!--[if lte IE 6]></td></tr></table></a><![endif]-->
							</li>
						</ul>';	
...
function sumaDiasNoInhabiles($fecha,$dias) 
{
	...
	//fecha es dd/mm/aaaa 
	$diasInhabiles[] = $yy."-01-01";
	$diasInhabiles[] = $yy."-01-02";
	$diasInhabiles[] = $yy."-01-03"; 
	$diasInhabiles[] = $yy."-02-03"; 
	$diasInhabiles[] = $yy."-03-17"; 
	$diasInhabiles[] = $yy."-04-17";
	$diasInhabiles[] = $yy."-04-18";
	$diasInhabiles[] = $yy."-05-01";	
	$diasInhabiles[] = $yy."-05-05";
	$diasInhabiles[] = $yy."-07-28";
	$diasInhabiles[] = $yy."-07-29";
	$diasInhabiles[] = $yy."-07-30";
	$diasInhabiles[] = $yy."-07-31";
	$diasInhabiles[] = $yy."-08-01";
	$diasInhabiles[] = $yy."-09-16";
	$diasInhabiles[] = $yy."-11-17";
	$diasInhabiles[] = $yy."-12-22";
	$diasInhabiles[] = $yy."-12-23";
	$diasInhabiles[] = $yy."-12-24";
	$diasInhabiles[] = $yy."-12-25";
	$diasInhabiles[] = $yy."-12-26";
	$diasInhabiles[] = $yy."-12-27";
	$diasInhabiles[] = $yy."-12-28";
	$diasInhabiles[] = $yy."-12-29";
	$diasInhabiles[] = $yy."-12-30";
	$diasInhabiles[] = $yy."-12-31";
...
{
	// buscamos si esta en medios
	$query = "SELECT estado FROM medios WHERE num_accion = '".$accion."' limit 1 ";
	$sql = mysql_query($query) or die(mysql_error()."<br><br>SQL: $query");
	$resMed = mysql_fetch_array($sql);
	$numMed = mysql_num_rows($sql);
...
function dameTotalPFRR($accion)
{
	...
	else $montoInicioPFRR = $r["monto_no_solventado_UAA"];
...
{
	//sacamos monto PO menos los resarcido y acalarado en PFRR, el resultado es el monto PFRR
	$query = "SELECT * FROM pfrr WHERE num_accion = '".$accion."' ";
	$sql = mysql_query($query) or die(mysql_error()."<br><br>SQL: $query");
	$r = mysql_fetch_array($sql);
...
{
	$fa = strtotime(date("Y-m-d")); $fl = strtotime("2015-01-17");
...
function enviaCorreo($nombre,$email,$asunto,$mensaje)
{
	...
	//$mail->AddAddress("rssanchez@asf.gob.mx","Ruben Sergio Sánchez");
