					...
					<ul class="select menu" id="mInicio">
						<li><a href="#" class="munuSup"><b>Medios Impugnación</b><!--[if IE 7]><!--></a><!--<![endif]-->
							<!--[if lte IE 6]><table><tr><td><![endif]-->
								...
								if($soloReportes != 1 && $direccion == "DG" )$menu .= '<li><a class="menu_md redonda3" href="?cont=actores"> <img src="images/medio_reconcideracion_small.png" /> <span> Ver Actores </span> </a>';
