	...
	function menu($direccion,$nivel,$soloReportes) 
	{
		if($direccion == "DG"  || $direccion == "A" || $direccion == "B" || $direccion == "C" || $direccion == "D" )
		{
			...
			$menu = '
				...
				//if($soloReportes != 1 ) $menu .= '<li><a class="menu_pfrr redonda3" href="?cont=estados"><img src="images/faqpfrr.png" /> <span>Estados</span></a></li>';
								...
								<ul class="sub submenu redonda5 ulMd">';
									...
									if($soloReportes != 1 )$menu .= '<li><a class="menu_md redonda3" href="#"> <img src="images/medio_actores_small.png" /> <span> Recurso de Reconsideración </span> </a>
																		<ul class="submenu2 redonda5">
																			...
																			<li> <a class="menu_md redonda3" href="?cont=mediosrr_busqueda&reports='.$soloReportes.'"> <img src="images/search16.png" /> Advanced Search </a> </li>
									...
									if($soloReportes != 1 )$menu .= '<li><a class="menu_md redonda3" href="#"> <img src="images/medio_nulidad_small.png" /> <span> Juicio de Nulidad </span> </a>
																		<ul class="submenu2 redonda5">
																			<li> <a class="menu_md redonda3" href="?cont=medios_jn_actores"> <img src="images/actor.png" /> Ver Actores </a> </li>
					...
					<ul class="select menu" id="mInicio">
						<li><a href="#nogo" class="munuSup"><b>Legal Opinions</b><!--[if IE 7]><!--></a><!--<![endif]-->
							<ul class="sub submenu redonda5 ulOpi">';
									...
									if($soloReportes != 1 )$menu .= '<li> <a class="menu_opi redonda3" href="?cont=sa_busqueda&reports='.$soloReportes.'"> <img src="images/search16.png" />Advanced Search</a></li>';
					...
					<!--[if lte IE 6]><table><tr><td><![endif]-->
						<ul class="sub submenu redonda5 ulRep">';
							...
							$menu .=  '<li><a class="menu_rep redonda3" href="#"> <img src="images/recuperaciones.png" width="14" height="16" /> <span>Reportes PFRR</span> </a>
									...
									$menu .=  '<li><a class="menu_rep redonda3" href="#"> <img src="images/book_red.png" width="14" height="16" /> <span>Reportes Medios</span> </a>
										<ul class="submenu2 redonda5">
											<li><a class="menu_rep redonda3" href="?cont=medios_rep"> <img src="images/historico.png" /> <span> Medios </span> </a></li>										
						...
						//2	$menu .= '<li><a class="menu_rep redonda3" href="?cont=po_asistidos"> <img src="images/asistidos.png" /> <span>Pliegos Asistidos</span> </a></li>';
							...
							$menu .= '<li><a class="menu_rep redonda3" href="?cont=informe_consejo"> <img src="images/errores.png" /> <span>Informe de Consejo</span> </a></li>';
														...
														$menu .= '<li><a class="menu_rep redonda3" href="?cont=bus_edo"> <img src="images/errores.png" /> <span>Informe Estatal</span> </a></li>';
					...
					<ul class="select menu" id="mInicio">
						...
						<!--[if lte IE 6]><table><tr><td><![endif]-->
							<ul class="sub submenu redonda5 ulAdm" >';
								if($soloReportes != 1)$menu .= '<li><a class="menu_adm redonda3" href="?cont=empleados"> <img src="images/presuntos.png" /> <span>Personal</span> </a></li>
...
function generaOficios($tipo = "",$fechaOficio, $horaOficio, $acciones, $presunto, $oficioRef, $remitente, $cargo, $dependencia, $asunto, $userForm, $dirForm, $tipoOficio)
{
	...
	$anioAnt = $fechaPartes[0];
	if($anioAnt='0000' ) $anioAnt='2017'; //--------------------------------------------------------MODIFICAR AÑO A PRINCIPIOS DEL 2018 "MUUUY IMPORTANTE"
