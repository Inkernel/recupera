...
function guardaPresunto()
{
	if(comprobarForm('presunto_NEW'))
	{
		...
		({
			...
			data: "funcion=nuevo&hora="+$$('#hora_cambio').val()+"&fecha="+$$('#fecha_cambio').val()+"&usuario="+$$('#usuarioActual').val()+"&num_accion="+$$('#num_accion').val()+"&idPresunto="+$$('#creacion').val()+"&tipoPresunto="+$$('#new_tipoPresunto').val()+"&servidor="+$$('#new_servidor_contratista').val()+"&cargo="+$$('#new_cargo_servidor').val()+"&dependencia="+$$('#new_dependencia_servidor').val()+"&irregularidad="+$$('#new_irregularidad').val()+"&monto="+$$('#new_monto').val(),
			error: function(objeto, quepaso, otroobj)
			{
				//alert("Estas viendo esto por que fallé");
				//alert("Pasó lo siguiente: "+quepaso);
...
function guardaPrescripcion()
{
	...
	{
		var confirma = confirm("La fecha de Irregularidad cambiara a "+$$('#f1_fecha_presc').val()+" \n\n ¿Desea continuar? ");
...
//------------------------------FUNCION AGREGA DATOS----------------------------------
function agregaDatosx(accion,usuario,direccion)
{
	//alert("aqui ando");
	$$.ajax
	({
		...
		if(confirma)
		{
			$$.ajax({
				...
				{ 	
					//alert(data);
					compruebaNot();
					new mostrarCuadro2(530,1100,$$("#nomPresunto1").val(),20,"cont/pfrr_presuntos_proceso.php","idPresuntop="+$$("#idFpresunto1").val()+"&numAccion="+$$("#accPresunto1").val()+"&usuario="+$$("#usuarioAud11").val()+"&direccion=")
					cerrarCuadro3();
				}
			});
			//cerrarCuadro();
		...
		if(confirma)
		{
			$$.ajax({
				...
				{ 	
					...
					compruebaNot();
					cerrarCuadro2();
					mostrarCuadro(500,1100," "+$$("#num_accion").val()+"&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"+$$("#entidad_fiscalizada").val()+"&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"+$$("#edoTraPro").val(),50,"cont/pfrr_proceso.php","numAccion="+$$("#num_accion").val()+"&usuario="+$$("#userDir").val()+"&direccion="+$$("#userDir").val()+"");
				}
			});
			//cerrarCuadro();
		}
...
function presuntoYresponsabilidad()
{
	...
	{
		var confirma = confirm(' Cambiará la responsabilidad de los presuntos \n\n ¿Desea continuar?');
		if(confirma)
		{
			$$.ajax({
				type: "POST",
				url: "procesosAjax/pfrr_presuntos_proceso.php",
				//beforeSend: function(){  },
				data: $$("#presuntosResponsabilidad").serialize()+"&tipoFecha=presuntoYresponsabilidad",
				success: function(data) 
				{ 	
					//alert(data);
					...
					compruebaNot();
					cerrarCuadro2();
					mostrarCuadro(500,1100," "+accion+"&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"+entidad_fiscalizada+"&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"+edoTraPro,50,"cont/pfrr_proceso.php","numAccion="+accion+"&usuario="+user+"&direccion="+direccion+"");
				}
			});
			//cerrarCuadro();
		}
