...
function formaTabla() {
 ...
 //   llave = e.options[e.selectedIndex].text;
    ...
    console.log($(searchForm).serialize());
        ...
        $.post( "x/jsonBuscaIrregularidad.php", $(searchForm).serialize() )
        .done(function( data ) {
        ...
        $.post( "x/jsonBuscaIrregularidadPresuntos.php", $(searchForm).serialize() )
        .done(function( data ) {
        ...
        $.post( "x/jsonBuscaCargo.php", $(searchForm).serialize() )
        .done(function( data ) {
        ...
        $.post( "x/jsonBuscaEntidad.php", $(searchForm).serialize() )
        .done(function( data ) {
        ...
        $.post( "x/jsonBuscaEntidadPresuntos.php", $(searchForm).serialize() )
        .done(function( data ) {
