...
<head>
    ...
    <script type="text/javascript" src="x/juicios.js"></script>
...
<body>
    ...
    <div id="lista">
        <div class="navbarJuicios">
            <a href="#" class="logo">Impugnados - Juicios Contencios Administrativos: <?php echo  $entidad . $direccion ; ?>  </a>
