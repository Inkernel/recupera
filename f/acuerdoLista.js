$(document).ready(function() {
    $('#juicios').DataTable( {
        ...
        language: {
            ...
            search:         "Busca&nbsp;:",
            lengthMenu:    "Muestra _MENU_ Presuntos Responsables",
            info:           "Mostrando registros del _START_ al _END_ de un total de _TOTAL_ Presuntos Responsables",
