        ...
        "columns": [
            {
                ...
                data:           null,
                width: "100px",
                defaultContent: '<a href="" title="Informacióndel Oficio" class="informacion icon-5 info-tooltip"></a>' + 
...
$('#juicios').on('click', 'a.informacion', function (e) {
    ...
    e.preventDefault();
    var pagina = 'cont/pfrr_oficio_notifica.php?id='+encodeURIComponent(row.data().num_accion)+ '&abogado=fllamas' + '&folio=DG';
