...
<table align="center" class='tablaInfo' width="100%">
		...
		<?php } ?>
          ...
          <tr>
			...
			<?php IF ($r['detalle_edo_tramite'] == "16")
			{ $edo = "Iniciado"; } 
			else { $edo = $r['estado_sicsa']; } ?>
            <td><p class="txtInfo"><?php echo $edo; ?></p></td>
          </tr>
          ...
          <tr>
            ...
            <td><p class="etiquetaInfo redonda3">ET Impugnado</p></td>
			<?php 
			...
			?>
            <td><p class="txtInfo"><?php echo $etimp['detalle_estado']; ?></p></td>
          </tr>
