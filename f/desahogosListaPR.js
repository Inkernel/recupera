$(document).ready(function() {
    $('#juicios').DataTable( {
        ...
        language: {
            ...
            search:         "Busca&nbsp;:",
            lengthMenu:    "Muestra _MENU_ Presunto Responsable",
            info:           "Mostrando registros del _START_ al _END_ de un total de _TOTAL_ Presunto Responsable",
        ...
        "columns": [
            ...
            { "data": "nombre" },
            { "data": "fecha_edo_tramite" },
            { "data": "cierre_instruccion" },
            { "data": "fecha_acuerdo_inicio" },
        ...
        "columnDefs": [
            ...
            dom:  '<"top"Birf>t<"bottom"lpi><"clear">', //'<"#boton"B><"top"fl>t<ipr><"clear">', //<#boton >frtip',  // <"top"B>irt<"bottom"flp><"clear">', //'Bfrtip',
            buttons: [
