...
<head>
    ...
    <title>Desahogosx procedimiento</title>

    <link rel="stylesheet" href="css/acuerdoLista.css">
    <link rel="stylesheet" href="js/datatables/dataTables.min.css">
    <link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/buttons/1.5.4/css/buttons.dataTables.min.css"/>

    <script type="text/javascript" src="f/desahogosListaProcedimiento.js"></script>
...
<body>
    ...
    <div id="lista">
        <div class="navbarJuicios">
            <a href="#" class="logo">Desahogos por Procedimiento</a>
